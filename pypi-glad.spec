...
Version  : 2.0.6
Release  : 9
URL      : https://github.com/Dav1dde/glad/archive/v2.0.6/glad-2.0.6.tar.gz
Source0  : https://github.com/Dav1dde/glad/archive/v2.0.6/glad-2.0.6.tar.gz
...
%prep
%setup -q -n glad-2.0.6
cd %{_builddir}/glad-2.0.6
pushd ..
cp -a glad-2.0.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710806539
