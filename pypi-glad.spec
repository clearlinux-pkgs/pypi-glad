...
Source0  : https://github.com/Dav1dde/glad/archive/v2.0.8/glad-2.0.8.tar.gz
...
%prep
%setup -q -n glad-2.0.8
cd %{_builddir}/glad-2.0.8
pushd ..
cp -a glad-2.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727607212
